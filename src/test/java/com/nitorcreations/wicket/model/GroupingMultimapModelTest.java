...
public class GroupingMultimapModelTest {
    ...
    List<TestObject> strings = new ArrayList<TestObject>(Arrays.asList(
            to("Foobarbaz"),
            to("c"),
            to("a"),
            to("b"),
    ...
    private static Entry<Integer, List<TestObject>> entries(String... strings) {
        List<TestObject> tos = new ArrayList<TestObject>();
        for (String s : strings) {
            tos.add(to(s));
        }
        return Pair.of(tos.get(0).getLength(), tos);
    }
    ...
    public void valuesModelSetObjectClearAndSetsForASingleKey() {
        ...
        assertThat(model.getObject(), contains(
                to("a"),
                to("b"),
                to("c"),
                to("Bur"),
    ...
    private static TestObject to(String s) {
    ...
    private static class TestObjectGroupingModel extends GroupingMultimapModel<Integer, TestObject> {
        ...
        public TestObjectGroupingModel(IModel<List<TestObject>> stringsModel) {super(stringsModel);}
